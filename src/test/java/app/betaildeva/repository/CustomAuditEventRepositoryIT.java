package app.betaildeva.repository;

import app.betaildeva.AppdevaApp;
import app.betaildeva.config.Constants;
import app.betaildeva.config.audit.AuditEventConverter;
import app.betaildeva.domain.PersistentAuditEvent;
...
import static app.betaildeva.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
